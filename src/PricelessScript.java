...
public class PricelessScript {
    ...
    public static void main(String[] args) {
        ...
        String happy = "Bonus: %s";
        String number = "number: %x";
        String decimal = "floating point: %f";
        System.out.println(String.format(happy, "yaaay!"));
        System.out.println(String.format(number, 4));
        System.out.println(String.format(decimal, 4.5));
