...
public class PricelessScript {
    ...
    public static void main(String[] args) {
        ...
        String scriptTemplateLine3 = "2 autographed baseball %s"; // Changed number of baseballs from 2 to 1
        String scriptTemplateLine4 = "watching the Giants win: %s"; //Changed text here from "real conversation with 11 year old son" to "watching the Giants win"
        String priceless = "priceless";

        // integer variable
        int people = 3; // Changed variable here from 2 to 3
        ...
        itemPrice = 90.0; // Changed Variable here from 45.0 to 90.0
        System.out.println(
